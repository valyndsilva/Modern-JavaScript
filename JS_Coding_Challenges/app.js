...
// 1. Julia found out that the owners of the first dog and the last two dogs actually have cats, not dogs! So create a shallow copy of Julia's array, and remove the cat ages from that copied array (because it's a bad practice to mutate function parameters)
...
const checkDogs = function(dogsJulia, dogsKate){
  ...
  // 1.
  const dogsJuliaCorrected = dogsJulia.slice(); // [3, 5, 2, 12, 7]
  dogsJuliaCorrected.splice(0,1); // [3]
  dogsJuliaCorrected.splice(-2); // [12, 7]
 ...
 // Alternate method to concat using ...spread operator
